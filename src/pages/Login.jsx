        ...
        <div className="col-span-2 flex flex-col justify-center md:py-0 py-24 bg-black/40 backdrop-blur px-10 gap-y-16 text-white">
          <div className="flex flex-col gap-y-6 ">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-y-4">
              ...
              <input className={`w-full bg-transparent border-0 border-b-2 ${error ? "border-red-800" : "border-white"} focus:border-green-500 focus:ring-0 p-2 focus:outline-none transition-colors text-lg font-semibold`} type="password" value={password} onChange={(e) => setPassword(e.target.value)} placeholder="Contraseña" />
              {error ? <span className="text-red-800 font-semibold text-lg text-center">Credenciales incorrectas</span> : null}
